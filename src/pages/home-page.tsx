...
// Phosphor icons
import { Robot, Plus, ArrowRight, Broadcast, WifiHigh, WifiSlash, BookOpen, Cpu } from "@phosphor-icons/react";
            ...
            <div className="max-w-5xl mx-auto space-y-12">
                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex gap-2">
                        ...
                        <Button variant="outline" className="gap-2" onClick={() => window.location.href = "/agents/registry"}>
                            <Cpu size={16} /> Fleet Commander
                        </Button>
